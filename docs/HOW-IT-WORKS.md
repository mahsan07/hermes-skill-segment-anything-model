...
![Step-by-step workflow for Segment Anything Model](../assets/workflow.svg)
...
![Safety and approval boundaries for Segment Anything Model](../assets/safety-boundary.svg)
