---
name: hermes-skill-segment-anything-model
description: Use SAM for zero-shot image segmentation with points, boxes, or masks. Use when the user explicitly requests this capability or a closely related task.
---
